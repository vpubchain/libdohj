...
// To run, grab the syscoinj bundled JAR and then do something like this:
//
//   jjs -cp syscoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp syscoinj-0.12-bundled.jar
//
...
//
//   jjs -cp syscoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And syscoinj is a threaded library. This means you
